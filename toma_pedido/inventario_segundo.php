...
header('Content-type: text/plain; charset=UTF-8');
    ...
    while($control == 0 ){ 
        ...
        if ($control == 0){
            ...
            for($i=0; $i<$longitud; $i++){ 
                ...
                $sql1_validar = "SELECT * FROM inventario WHERE item_id = '".$item_id."' AND ubicacion_id = '".$ubicacion_id."'";
    ...
    print("creados: " . $valores_creados . "\n\n");
    print("acualizados: " . $valores_actualizados . "\n\n");
