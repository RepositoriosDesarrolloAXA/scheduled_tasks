...
//sigue
    ...
    while($control == 0 ){ 
        ...
        if ($inicio== 0){
            $url = "https://4572765.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=2050&deploy=1&start=$start&end=$end";
        }
        ...
        if ($control == 0){
            ...
            for($i=0; $i<$longitud; $i++){ 
                ...
                $id_axlp                        = $data[$i]["values"]["internalid"][$y]["text"];
            	...
            	if(!empty($id_axlp)){
                	...
                	$sql1_validar = "SELECT id FROM axlp WHERE id = '".$id_axlp."'";
    ...
    $sql_log = "INSERT INTO log (proceso, tabla, cant_registro, cant_insertados, 
        ...
        ('ACTUALIZACION', 'axlp_inactivos', $cantidad_registros, $valores_creados, $valores_actualizados, 
